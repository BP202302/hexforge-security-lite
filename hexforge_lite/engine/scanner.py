...
from ..plugins import load_lite_plugins
from ..output import FindingFormatter
...
class ScanEngine:
    def __init__(self) -> None:
        ...
        self.modules.extend(load_lite_plugins())
    ...
    def _validate(self, findings: Iterable[Finding]) -> List[Finding]:
        ...
        return self.formatter.sort(self.dedup.filter(validated))
    ...
    def scan(self, url: str) -> dict:
        ...
        summary = self.scorer.summarize(findings)
        report = ScanReport(
            ok=True,
            url=normalized,
            ...
            summary=summary,
            surface_map=context.artifacts.get("surface_map", {}),
